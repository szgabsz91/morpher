...
public class RemovalTest {
    ...
    public void testIsInhomogeneous(ICharacterRepository characterRepository) {
        Removal inhomogeneousRemoval = new Removal(Set.of(), characterRepository);
        assertThat(inhomogeneousRemoval.isInhomogeneous()).isTrue();

        Removal homogeneousRemoval = new Removal(Set.of(Length.SHORT), characterRepository);
        assertThat(homogeneousRemoval.isInhomogeneous()).isFalse();
    }
