...
public class RuleTest {
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    public void testTransformWithInhomogeneousRule(
            ICharacterRepository characterRepository,
            IWordConverter wordConverter,
            IWordPairProcessor wordPairProcessor) {
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    public void testTransformFromFrontWithInhomogeneousRule(
            ICharacterRepository characterRepository,
            IWordConverter wordConverter,
            IWordPairProcessor wordPairProcessor) {
        Context context = new Context(List.of(), List.of(), List.of(), null, null);
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    public void testTransformFromBackWithInhomogeneousRule(
            ICharacterRepository characterRepository,
            IWordConverter wordConverter,
            IWordPairProcessor wordPairProcessor) {
        Context context = new Context(List.of(), List.of(), List.of(), null, null);
