...
public class FullMarkovModelTest {
    ...
    public class MarkovModelTest {
        ...
        @Test
        public void testIsAffixTypeOrderValidWithValidOrder() {
            ...
            boolean result = this.markovModel.isAffixTypeOrderValid(affixTypes);
            assertThat(result).isTrue();
        }

        @Test
        public void testIsAffixTypeOrderValidWithInvalidOrder() {
            this.markovModel.add(List.of(AffixType.of("POS1"), AffixType.of("AFF1"), AffixType.of("AFF13")));
            this.markovModel.add(List.of(AffixType.of("POS2"), AffixType.of("AFF1"), AffixType.of("AFF12")));
            this.markovModel.add(List.of(AffixType.of("POS2"), AffixType.of("AFF1"), AffixType.of("AFF12")));
        ...
        public void testSortAffixTypes() {
            ...
            List<MarkovRoute> markovRoutes = this.markovModel.sortAffixTypes(Set.of(AffixType.of("/NOUN"), AffixType.of("<PLUR>"), AffixType.of("<CAS<ACC>>")), affixType -> affixType.toString().startsWith("/"));
            assertThat(markovRoutes).hasSize(2);

            MarkovRoute markovRoute1 = markovRoutes
                    .stream()
                    .filter(markovRoute -> markovRoute.getAffixTypes().stream().map(ProbabilisticAffixType::getAffixType).collect(toList()).get(1).equals(AffixType.of("<PLUR>")))
                    .findFirst()
                    .get();
            assertThat(markovRoute1.getAffixTypes()).containsExactly(
            ...
            assertThat(markovRoute1.getProbability()).isEqualTo(1 / 3.0);

            MarkovRoute markovRoute2 = markovRoutes
                    .stream()
                    .filter(markovRoute -> markovRoute.getAffixTypes().stream().map(ProbabilisticAffixType::getAffixType).collect(toList()).get(1).equals(AffixType.of("<CAS<ACC>>")))
                    .findFirst()
                    .get();
            assertThat(markovRoute2.getAffixTypes()).containsExactly(
                    ProbabilisticAffixType.of(AffixType.of("/NOUN"), 5 / 6.0),
                    ProbabilisticAffixType.of(AffixType.of("<CAS<ACC>>"), 2 / 5.0),
                    ProbabilisticAffixType.of(AffixType.of("<PLUR>"), 0.5)
            );
            assertThat(markovRoute2.getProbability()).isCloseTo(1 / 6.0, Offset.strictOffset(0.000005));
        }
        ...
        public void testCalculateProbabilitiesWithKnownRoute() {
            ...
            MarkovRoute markovRoute = this.markovModel.calculateProbabilities(List.of(AffixType.of("<CAS<ACC>>"), AffixType.of("<PLUR>")));
            assertThat(markovRoute.getAffixTypes()).containsExactly(
                    ProbabilisticAffixType.of(AffixType.of("/NOUN"), 5 / 6.0),
                    ProbabilisticAffixType.of(AffixType.of("<CAS<ACC>>"), 2 / 5.0),
                    ProbabilisticAffixType.of(AffixType.of("<PLUR>"), 0.5)
            );
            assertThat(markovRoute.getProbability()).isCloseTo(1 / 6.0, Offset.strictOffset(0.000005));
        }
        ...
        public void testCalculateProbabilitiesWithUnknownRoute() {
            ...
            MarkovRoute markovRoute = this.markovModel.calculateProbabilities(List.of(AffixType.of("<CAS<ACC>>"), AffixType.of("<X>"), AffixType.of("<Y>")));
            assertThat(markovRoute.getAffixTypes()).containsExactly(
                    ProbabilisticAffixType.of(AffixType.of("/NOUN"), 5 / 6.0),
                    ProbabilisticAffixType.of(AffixType.of("<CAS<ACC>>"), 2 / 5.0),
            ...
            assertThat(markovRoute.getProbability()).isEqualTo(0.0);
        }
        ...
        public void testCalculateProbabilitiesWithUnknownPos() {
            ...
            MarkovRoute markovRoute = this.markovModel.calculateProbabilities(List.of(AffixType.of("<Y>")));
            assertThat(markovRoute.getAffixTypes()).containsExactly(
                    ProbabilisticAffixType.of(AffixType.of("<Y>"), 0.0)
            );
            assertThat(markovRoute.getProbability()).isEqualTo(0.0);
