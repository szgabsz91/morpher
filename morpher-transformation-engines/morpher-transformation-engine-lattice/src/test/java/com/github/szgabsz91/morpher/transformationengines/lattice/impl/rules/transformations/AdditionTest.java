...
public class AdditionTest {
    ...
    public void testIsInconsistent(ICharacterRepository characterRepository) {
        Addition inconsistentAddition = new Addition(Set.of(), characterRepository);
        assertThat(inconsistentAddition.isInconsistent()).isTrue();

        Addition consistentAddition = new Addition(Set.of(Length.SHORT), characterRepository);
        assertThat(consistentAddition.isInconsistent()).isFalse();
    }
