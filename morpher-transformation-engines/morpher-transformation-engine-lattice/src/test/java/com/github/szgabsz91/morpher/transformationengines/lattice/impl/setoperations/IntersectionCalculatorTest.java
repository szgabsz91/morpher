...
import static com.github.szgabsz91.morpher.transformationengines.lattice.impl.setoperations.SubsetCalculator.isSubsetOf;
...
public class IntersectionCalculatorTest {
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    public void testIntersectWithInconsistentNode1AndInconsistentNode2(ICharacterRepository characterRepository) throws IntersectionException {
        Rule rule = new Rule(
                new Context(
                        List.of(),
                        List.of(),
        ...
        assertThat(intersection.isInconsistent()).isTrue();
    }

    @ParameterizedTest
    @MethodSource("parameters")
    public void testIntersectWithInconsistentNode1AndConsistentNode2(ICharacterRepository characterRepository) throws IntersectionException {
        Rule rule = new Rule(
                new Context(
                        List.of(),
                        List.of(),
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    public void testIntersectWithConsistentNode1AndInconsistentNode2(ICharacterRepository characterRepository) throws IntersectionException {
        Rule rule = new Rule(
                new Context(
                        List.of(),
                        List.of(),
    ...
    @Test
    public void testIntersectWithConsistentNodeBecomingInconsistentBasedOnNode1WithHungarianAttributedCharacterRepository() throws IntersectionException {
    ...
    @Test
    public void testIntersectWithConsistentNodeBecomingInconsistentBasedOnNode1WithHungarianSimpleCharacterRepository() {
    ...
    @Test
    public void testIntersectWithUnitNodeAndNode() throws IntersectionException {
    ...
    @Test
    public void testIntersectWithZeroNodeAndNode() throws IntersectionException {
    ...
    @ParameterizedTest
    @MethodSource("ruleParameters")
    public void testIntersectWithTheSecondTransformationIntersectionBecomingInconsistent(
            ICharacterRepository characterRepository,
            IWordConverter wordConverter,
