...
import static com.github.szgabsz91.morpher.transformationengines.lattice.impl.setoperations.SubsetCalculator.isSubsetOfPosition;
...
public class SubsetCalculatorTest {
    ...
    public void testIsSubsetOfWithNodeAndUnitNode(ICharacterRepository characterRepository) {
        Node node = new Node(null);
        boolean result = isSubsetOf(node, new UnitNode());
        assertThat(result).isFalse();
    }

    @ParameterizedTest
    @MethodSource("parameters")
    public void testIsSubsetOfWithNodeAndZeroNode(ICharacterRepository characterRepository) {
        Node node = new Node(null);
        boolean result = isSubsetOf(node, new ZeroNode());
    ...
    @Test
    public void testIsSubsetOfWithUnitNodeAndNode() {
    ...
    @Test
    public void testIsSubsetOfWithZeroNodeAndNode() {
