...
public class ReplacementTest {
    ...
    public void testIsInconsistent(ICharacterRepository characterRepository) {
        Replacement inconsistentReplacement = new Replacement(Set.of(), characterRepository);
        assertThat(inconsistentReplacement.isInconsistent()).isTrue();

        @SuppressWarnings({ "rawtypes", "unchecked" })
        Replacement consistentReplacement = new Replacement(
                new HashSet(List.of(Length.class, Length.LONG, Length.SHORT)),
                characterRepository
        );
        assertThat(consistentReplacement.isInconsistent()).isFalse();
    }
