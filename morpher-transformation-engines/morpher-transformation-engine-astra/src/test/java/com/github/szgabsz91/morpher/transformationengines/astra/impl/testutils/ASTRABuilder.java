package com.github.szgabsz91.morpher.transformationengines.astra.impl.testutils;
...
public class ASTRABuilder {
    ...
    public static final double DEFAULT_FITNESS_THRESHOLD = ASTRATransformationEngineConfiguration.Builder.DEFAULT_FITNESS_THRESHOLD;
    public static final int DEFAULT_MAXIMUM_NUMBER_OF_RESPONSES = ASTRATransformationEngineConfiguration.Builder.DEFAULT_MAXIMUM_NUMBER_OF_RESPONSES;
    ...
    public ASTRABuilder() {
        ...
        this.searcher = createDefaultSearcher();
    ...
    public static ISearcher createDefaultSearcher() {
        return new SequentialSearcher(DEFAULT_ATOMIC_RULE_FITNESS_CALCULATOR, false);
    }
