...
public class SequentialSearcherTest {
    ...
    public void testSearchAtomicRuleCandidatesForBackwardsTransformationWithUnidirectionalTransformationEngine() {
        ...
        assertThat(exception).hasMessage("Unidirectional SequentialSearcher cannot be used for backwards transformation");
    }
    ...
    public void testRemoveAtomicRule() {
        ...
        AtomicRuleCandidate[] forwardsCandidates = searcher.searchAtomicRuleCandidatesForForwardsTransformation("efh");
        assertThat(forwardsCandidates).containsExactly(new AtomicRuleCandidate(null, atomicRule4, 1.0));
        AtomicRuleCandidate[] backwardsCandidates = searcher.searchAtomicRuleCandidatesForForwardsTransformation("efh");
        assertThat(backwardsCandidates).containsExactly(new AtomicRuleCandidate(null, atomicRule4, 1.0));
    }
