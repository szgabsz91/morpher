...
public class CharacterTransformationEngine implements IBidirectionalTransformationEngine<GeneratedMessageV3> {
    ...
    public CharacterTransformationEngine(String character, Random random) {
    ...
    @Override
    public Optional<TransformationEngineResponse> transform(Word input) {
        String inputString = input.toString();
        List<RandomizableCharacter> randomizableCharacters = parse(inputString);
        ...
        int occurrences = StringUtils.countMatches(inputString, this.character);
        ...
        return Optional.of(TransformationEngineResponse.singleton(randomizedWord));
    }

    @Override
    public Optional<TransformationEngineResponse> transformBack(Word input) {
        String inputString = input.toString();
        final List<RandomizableCharacter> randomizableCharacters = parse(inputString);
        ...
        TransformationEngineResponse transformationEngineResponse = TransformationEngineResponse.singleton(resultingWord);
